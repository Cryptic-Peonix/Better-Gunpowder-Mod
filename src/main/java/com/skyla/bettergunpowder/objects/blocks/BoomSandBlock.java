...
public class BoomSandBlock extends AbstractFallingTNTBlock {

	public BoomSandBlock(Properties properties) {
		super(properties);
	...
	public void onExplosionDestroy(World worldIn, BlockPos pos, Explosion explosionIn) {
		if (!worldIn.isRemote) {
			BoomSandEntity entity = new BoomSandEntity(worldIn, (double) ((float) pos.getX() + 0.5f),
	...
	public static void explode(World worldIn, BlockPos pos, @Nullable LivingEntity entityIn) {
		if (!worldIn.isRemote) {
			BoomSandEntity entity = new BoomSandEntity(worldIn, (double) pos.getX() + 0.5D,
